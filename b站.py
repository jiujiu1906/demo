import subprocess,os, execjs, jsonpath
import time, json, re, requests

base_url = f"https://api.bilibili.com/x/polymer/web-space/seasons_archives_list?mid=3546633616754929&season_id=5887399&sort_reverse=false&page_size=30&page_num=1&web_location=333.1387"
headers = {
    "accept": "*/*",
    "accept-language": "zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6",
    "origin": "https://space.bilibili.com",
    "priority": "u=1, i",
    "referer": "https://space.bilibili.com/3546633616754929/lists/5887399?type=season",
...
cookies = {
    ...
    "bp_t_offset_3706989999819155": "1203032966813450240",
    "bsource": "search_bing",
    "sid": "4jotdb6r",
    "CURRENT_FNVAL": "2000",
    "b_lsid": "FD690B6E_19E35D29169"
}
...
res_ = jsonpath.jsonpath(py_data, "$..bvid")
# print(res_)
a = 1
for i in res_:
    base_url = f"https://www.bilibili.com/video/{i}/"
    params = {
    ...
    # print(audio_url)
    # 获取视频数据
    video_data = requests.get(url=video_data, headers=headers, cookies=cookies).content
    # 获取音频数据
    audio_data = requests.get(url=audio_url, headers=headers, cookies=cookies).content
    # 保存 数据
    ...
    # 视频音频合并
    subprocess.run(["ffmpeg", "-i", "video.mp4", "-i", "audio.mp3", "-c", "copy", f"output{a}.mp4"])
    # 删除音频和视频
    os.remove("audio.mp3")
    os.remove("video.mp4")
    a += 1
